...
date: "2024-03-17"
categories: [grasp, pointcloud, paper]
toc: true
...
Grasp pose를 생성하기 위해 다음과 같이 문제의 용어들을 정의합니다.
...
VCGS의 기본적인 틀은 VAE 구조를 차용해서 학습 모델을 아래와 같이 만들었습니다.
...
Gasp를 다양하게 Sampling하기 위해 Encoder와 Decoder를 VAE 구조를 차용하여 Gaussian Prior Distribution을 이용해서 가능한 다양한 Grasp pose를 생성할 수 있도록 설계했습니다.
...
1. constrained grasping에서 grasp success rate에 대한 정의?
