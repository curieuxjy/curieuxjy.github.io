...
이번 포스팅에서는 인텔 RealSense 카메라에서 비디오를 스트리밍하고 OpenCV로 표시하기 위해 C++로 두 개의 ROS 2 노드를 생성하는 방법에 대해 설명하겠습니다. 또한 `librealsense2`를 연결하는 등 일반적인 빌드 문제도 다룰 예정입니다.


<center>
<img src="../../images/2025-02-02-realsense-ros2/ros2_realsense.png" width="67%" />
</center>


이 간단한 ROS2 프로젝트를 시작하기 앞서, 아래의 전제 조건들을 확인해서 먼저 환경을 셋팅해주시기 바랍니다.
